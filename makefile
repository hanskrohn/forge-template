...
build-for-all-environments:
	...
	GOOS=windows GOARCH=386 $(GOBUILD) -o $(BINARY_NAME)-windows-386.exe -v
	GOOS=windows GOARCH=amd64 $(GOBUILD) -o $(BINARY_NAME)-windows-arm.exe -v
	GOOS=windows GOARCH=386 $(GOBUILD) -o $(BINARY_NAME)-windows-arm64.exe -v
...
clean:
	...
	rm -rf $(BINARY_NAME)-windows-amd64.exe
	rm -rf $(BINARY_NAME)-windows-386.exe
	rm -rf $(BINARY_NAME)-windows-arm.exe
	rm -rf $(BINARY_NAME)-windows-arm64.exe
